  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-background/95 backdrop-blur-md border-t border-border/50 px-4 py-3 safe-area-bottom">
      <div className="flex gap-3">
        <Button size="lg" className="flex-1 bg-golden hover:bg-golden/90 text-foreground font-bold rounded-full shadow-lg text-base py-5" asChild>
          <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
            <WhatsAppIcon className="w-5 h-5 mr-2" />
            WhatsApp
          </a>
        </Button>
        <Button size="lg" variant="outline" className="flex-1 font-bold rounded-full shadow-lg text-base py-5" asChild>
