    ...
    <section id="particuliers" className="py-16 px-4">
      <div className="container mx-auto">
        ...
        <p className="text-center text-gray-600 mb-12 text-lg">
          Pour toi, surfeur – des souvenirs inoubliables de tes sessions
        </p>
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="relative overflow-hidden hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white to-yellow-50 border-yellow-200">
            ...
            <CardHeader className="text-center pb-4">
              <div className="inline-block bg-gradient-to-r from-yellow-400 to-purple-500 text-white text-sm font-semibold px-4 py-2 rounded-full mb-4 mx-auto">
                🏄 Pour toi
              </div>
            ...
            <CardContent className="text-center">
              ...
              <div className="grid grid-cols-2 gap-4 text-gray-700 mb-8">
                ...
                <div className="flex items-center justify-center gap-2 bg-purple-50 p-4 rounded-xl">
                  ...
                  <span className="font-medium">Solo / duo / groupe</span>
                </div>
                <div className="flex items-center justify-center gap-2 bg-purple-50 p-4 rounded-xl">
