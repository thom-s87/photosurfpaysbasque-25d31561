      ...
      <div className="container mx-auto max-w-3xl">
        <div className="flex justify-center">
          <button
            ...
            className="text-muted-foreground hover:text-foreground transition-colors text-sm tracking-wide uppercase flex items-center gap-2"
          >
            En savoir plus
        ...
        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isOpen ? 'max-h-[2000px] opacity-100 mt-8' : 'max-h-0 opacity-0'}`}>
          <div className="text-muted-foreground text-sm leading-relaxed space-y-4">
            ...
            <h4 className="font-serif text-base text-foreground pt-2">
